    ...
    cities = [
      {
        ...
        "app_metadata" => '{"side_menu_background_url":"img/app-images/side-menu-backgrounds/pittsburgh-pa.png","side_menu_background_color":"#97c93c","smell_description_placeholder_text":"industrial, woodsmoke, rotten-eggs"}'
      },
      {
        "name" => "Louisville",
        "state_code" => "KY",
        ...
        "app_metadata" => '{"side_menu_background_url":"img/app-images/side-menu-backgrounds/louisville-ky.png","side_menu_background_color":"#24bab1","smell_description_placeholder_text":"chemical, sewer-like, flowery, burnt"}'
      }
    ]
    cities.each do |city|
      city_obj = City.new
